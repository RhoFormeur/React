...
export const CardAnnonce = props => {
  const { listAnnonce } = props;

  return (
    <Box>
      <Text>Liste d'Annonces</Text>
      <VStack>
        {listAnnonce.map(item => {
          return (
            <Grid
            ...
            >
              <GridItem marginRight={'3'} area={'img'}>
                <Image borderRadius={'full'} border={'2px'} borderColor={'primary.50'} bg={'darkness.500'} src={item.avatar} />
              </GridItem>
